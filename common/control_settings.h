...
inline constexpr Setting kSettings[] = {
    ...
    {"working-scale", 'w', &ShmHeader::workingScaleBits, true, 0.25, 2, "Proxy scale relative to game resolution, capped by worker tier"},
    {"downscaler", 'f', &ShmHeader::scalingDownscaler, false, 1, 7, "1 bicubic, 2 catmull, 3 lanczos2, 4 lanczos3, 5 kaiser2, 6 kaiser3, 7 magic"},
