...
void usage(FILE* out)
{
    ...
    std::fprintf(out,
        ...
        "                          Write a unique token to DIR/request to trace\n"
        "                          one frame; DIR/TOKEN/summary.json completes it\n"
        "                          Dumps every pass input, raw output and tuning\n"
        "                          into PFM files; serving real inference only\n"
